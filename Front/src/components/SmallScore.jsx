    ...
    <ScoreCard>
      <CardContent className='CardContent' style={{height:"300px"}}>
        <Typography variant="h5" component="div">
          Credit Scoring for Small Entreprise
        </Typography>
        {!score && !loading && (
          <button className="btnn" onClick={fetchScores} disabled={loading}>
            <svg style={{top:"30.2%" , marginLeft:"669px"}} width="180px" height="60px" viewBox="0 0 180 60" >
        ...
        {score && (
          <>
            ...
            <Box className="score-circle" sx={{ mt: 2 }} style={{marginLeft:"608px"}}>
              <svg
                width="200"
                height="200"
                viewBox="0 0 200 200"
